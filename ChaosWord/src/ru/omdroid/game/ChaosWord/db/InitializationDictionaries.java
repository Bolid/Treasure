...
public class InitializationDictionaries extends SQLiteOpenHelper{
    private final String TAG = InitializationDictionaries.class.getName();
    ...
    public InitializationDictionaries(Context context) {
