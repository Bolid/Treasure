            ...
            public void onClick(View view) {
                ...
                if (!controlEdittext()){
                    for (int j = 0; j < i; j++){
                        ...
                        Arithmetic arithmetic = new Arithmetic(Double.valueOf(inData.get(0)), Integer.valueOf(inData.get(1)), Double.valueOf(inData.get(2)), Double.valueOf(inData.get(3)), false);
